...
color02="bd/ad/48" # Base 0B - Green complementario
color03="f0/c6/74" # Base 0A - Yellow
#color04="81/a2/be" # Base 0D - Blue Original
color04="27/44/52" # Base 0D - Blue complementario
color04="4d/72/84" # Base 0D - Blue complementario 2
